...
def build(kit=None):
    ...
    for k, (arc_, A) in enumerate(PP["arcades"]):
        kit.add(f"PORCH-frieze-{k}", "Terracotta", arc_, P=compose(FT.ARCADE_PRINT, inv34(A)), group="porch")
    ...
    kit.add("PORCH-roof-top", "Charcoal", proof.trim_by_plane([0, 0, 1.0], ptop - 0.8), group="porch")
