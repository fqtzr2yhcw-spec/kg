...
cornice at every level (the table under "Cornices per building"). The shops were resized the
same way (Rev C): about twice their old floor plans, house-height storeys (42 and 38 mm),
house-size windows and more bays, so they stand in scale beside the houses. The lineup render is `out/lineup/cycles/lineup.png` (built by merging each
...
| 2 | The Ashby | Italianate villa, 180 x 156 mm plus a kitchen ell (Rev C): cream common-bond brick with stone quoins, a canted bay, a low standing-seam hip with a V-groove cupola, a full-width porch on chamfered posts, two more upstairs windows at the back (Rev D), panel shutters; cornices of green coffers (joint), a green vine scroll on paired scroll brackets (eave), pearls (ell) and oculi (cupola) | done: 123 parts, print files (22 h 56 m, 621 g; 5 plates with one filament change) |
...
| 8 | The Merritt | Stick style, 170 x 140 mm (Rev B): a front-gabled block with a cross-gabled wing, open gable trusses, stickwork framing with X-braced panels, a braced porch; cornices of oxide-red stick frames (joint) and X-braced panels on diagonal knee braces (eave) | done: 52 parts, print files (19 h 11 m, 457 g; 2 plates with one filament change) |
| 9 | The Hollis | Folk Victorian farmhouse, an L 176 x 136 mm (Rev B): Dutch lap siding with chevron boarding in the gables, gingerbread gables, pedimented window crowns, board shutters, a spindle porch in the corner of the L and a back porch along the wing (Rev C); cornices of a green chain of diamonds (joint) and sawn teeth on knee brackets (eave) | done: 96 parts, print files (16 h 39 m, 451 g; 3 plates with one filament change) |
| 10 | The Carrow | Queen Anne castle, 168 x 132 mm (Rev B): Roman brick under a half-timbered storey, a round turret to a witch's-hat spire, a front gable with an arch-braced Tudor truss over a Palladian window, a wraparound Eastlake porch; cornices of plum strapwork (joint), Tudor roses on modillions (eave, round the turret) and a crenellated frieze on volutes (turret) | done: 64 parts, print files (21 h 6 m, 498 g; 4 plates with one filament change) |
| 11 | The Pemberton Block | Main Street: three-storey brick commercial block, 1868 (131 x 156 mm, two storefronts, Rev C). English-bond front with rowlock arches, a soldier course and a corbel table; two cast-iron storefronts (fluted columns, panelled bulkheads, prism-glass transoms) with recessed entries, DRY GOODS and BOOTS & SHOES, either side of the street door; gilt-lettered sign bands under a dentilled store cornice; panelled frieze and pressed-metal bracketed cap (the double cornice); name-and-date tablet on the parapet | done: 42 parts, print files (10 h 35 m, 265 g) |
| 12 | Keller's Barber Shop | Main Street: one-storey false-front shop, 1891 (86 x 140 mm with its boardwalk, Rev C). Rustic (half-log) siding on the front, vertical boards on the sides, beaded corner boards; storefront with panelled pilasters, lozenge bulkheads and a single glazed door; striped awning with a pinked hem; sign board; frieze on jigsawn brackets under a red cap; gable date tablet; rolled-roofing gable roof with a stovepipe; plank boardwalk and barber pole | done: 24 parts, print files (4 h 44 m, 97 g) |
| 13 | The Merchants Bank | Main Street: two-storey stone corner bank, 1882 (108 x 136 mm, Rev C). Banded rustication below and fine ashlar above a torus belt; round-arched banking-hall windows under stepped archivolts; pedimented windows upstairs; a temple doorway (pilasters, BANK entablature, segmental pediment, grille doors, ring transom) on the cut corner up granite steps; gilt-lettered frieze under a modillion-and-dentil cap mitred round the corner; bottle-baluster balustrade; glass skylight; coped chimney | done: 42 parts, print files (5 h 55 m, 177 g) |
| 14 | Hartley's General Store | Main Street: two-storey false-front store, 1879 (97 x 146 mm with its gallery, Rev C). Vertical lapped boards on stone piers with board skirting; a two-storey gallery (square posts with pierced gussets on a flagstone sidewalk, a planked balcony with a picket railing, a corrugated-iron shed roof); storefront with chamfered wooden pilasters, beaded-board bulkheads and small-paned display windows, a recessed pair of glazed doors; sign board, dogtooth frieze, cornice and an arched centre with the date; corrugated shed roof and a hooded brick flue | done: 37 parts, print files (6 h 53 m, 162 g) |
| 15 | Whitcomb's Pharmacy | Main Street: two-storey corner drugstore, 1885 (107 x 131 mm, Rev C). Banded buff brick on a bossed stone base; the corner cut back for the entrance behind a cast-iron column, margin-light doors under an arched transom; an octagonal turret corbelled out of the corner with a copper bell roof and an onion finial; two storefronts (rosette pilasters, tiled bulkheads) under lettered sign bands; cavetto belt; shouldered lintels upstairs; panelled frieze under a cap on volute brackets; mortar-and-pestle blade sign; gravel roof, stepped chimney | done: 41 parts, print files (6 h 54 m, 169 g) |
| 16 | The Palace Hotel & Saloon | Main Street: three-storey false-front hotel, 1883 (94 x 140 mm with its balcony, Rev C). Coursed square-butt shingles on a cobble base with rolled belts; the saloon's batwing doorway and the hotel's French doors with HOTEL in the transom; a full-width balcony on five knee brackets with a wrought-iron ring railing and a planked deck; 3-over-1 windows under drip caps; a vertical HOTEL sign; PALACE HOTEL false front with a cornice and a dated crest; board-and-batten gable roof, two slab-capped chimneys | done: 59 parts, print files (9 h 33 m, 208 g) |
| 17 | Vogel's Bakery | Main Street: one-and-a-half-storey brick bakery, 1895 (84 x 114 mm, Rev C). Monk-bond brick on a herringbone brick base; a crow-stepped front gable with stone copings on every step and a date stone; a round-arched shop window of small panes under a dog-tooth brick arch keyed with stone; a Dutch door with a heart in its transom; BAKERY sign board; gilt pretzel on a scrolled iron arm; pantile roof, tapered oven stack | done: 36 parts, print files (3 h 54 m, 87 g) |
| 18 | Bassett Hardware & Feed | Main Street: two-storey stone store, 1872 (99 x 138 mm, Rev C). Split-face limestone on a battered base with a string course; three round-arched bays under voussoir rings (two display windows, glazed board doors under a fanlight); upstairs, windows under splayed jack arches with iron fire shutters, and a loading door under a hoist beam with pulley, rope, block and hook; lettered frieze, cornice and date panel; stepped side parapets over a shingled shed roof | done: 36 parts, print files (4 h 45 m, 136 g) |
| 19 | Madame Dufresne's Millinery | Main Street: narrow two-storey milliner's shop, 1880 (73 x 124 mm, Rev C). A pressed-metal front (raised panels with bosses between plain stiles; its own part, printed face-up) on brick sides in Flemish garden-wall bond; a canted display bay with a hipped roof on a stone plinth; a door with a lozenge light, a scalloped transom and a crested cap up two steps; italic "Millinery" sign; ovolo belt; 6-over-1 windows under crested caps; gilt hat blade sign; lettered frieze on beaded brackets; a false mansard of octagon slates with a pedimented dormer carrying the date; flat tin roof with a glazed monitor, twin-flue chimney | done: 31 parts, print files (5 h 3 m, 121 g) |
| 20 | Ashworth & Sons, Jewelers | Main Street: narrow two-storey terra-cotta shop, 1893 (63 x 131 mm with its sidewalk, Rev C). Buff terra-cotta blocks with bands of button rosettes (its own part, printed face-up) on header-bond brick sides; one great round arch under a moulded terra-cotta band with imposts and a keystone carrying an "A", filled by a shop front (display window lettered WATCHES, a door with two round-headed lights, a radial fanlight); cyma belt; a canted oriel on a corbel with a copper roof between two 2-over-1 windows under triple-keyed lintels; egg-and-dart frieze lettered ASHWORTH & SONS, cornice, dated parapet panel; a four-faced street clock on a hexagon-paved sidewalk; gilt pocket-watch sign; flat copper roof in lozenge sheets, round chimney stack | done: 31 parts, print files (5 h 3 m, 112 g) |
| 21 | The Marigold | Gingerbread cottage after the user's photo, 124 x 172 mm (Rev B): turquoise ogee lap, a front gable dressed in gold lace (bargeboard, screen, fan hood), a full-width lace porch on orange posts, cove-cut shingles, flower boxes and a rocking chair; an eave cornice of gold linked rings on jigsawn brackets | done: 52 parts, print files (14 h 58 m, 351 g; 2 plates with one filament change) |
| 22 | The Primrose | Eastlake Queen Anne after the user's photo, 176 x 148 mm (Rev B): butter double lap, a flat-topped hip with a walk rail, a front wing with an Eastlake sunburst gable, a porch sweeping round its corner on bobbin posts; cornices of spindles (joint) and a burgundy guilloche on beaded brackets (eave) | done: 89 parts, print files (19 h 8 m, 506 g; 3 plates with one filament change) |
| 23 | The Rosecroft | Stick-style tower house after the user's photo, 210 x 124 mm (Rev C): coral rabbeted bevel, a broad octagonal tower to a crown of eight gablets with framed lancets and roundels, a teal lantern and a spire with a vane, two wheel gables, a canted bay, a porch round the tower; cornices of a teal Greek key (joint), triglyphs on fret brackets (eave) and a diaper frieze (tower) | done: 78 parts, print files (21 h 15 m, 554 g; 3 plates with one filament change) |
...
| 25 | The Larkspur | Queen Anne after the user's photo, 196 x 136 mm (Rev B): turquoise chamfered lap under chisel-cut shingles, a gabled wing with a Free Classic pediment and fan, a round tower to a bell-cast cone, an arcaded loggia in the upper storey, a gabled dormer, a porch curving round the tower; cornices of a navy running wave (joint), rosettes on cove brackets (eave) and scrolls (tower) | done: 79 parts, print files (27 h 40 m, 658 g; 3 plates with one filament change) |
| 26 | The Juniper | Queen Anne after the user's photo, 196 x 140 mm (Rev B): olive lap under sage hexagon shingles, a round corner tower to a swallowtail cone, pendant gables, a three-light dormer, an oval window, a porch round the tower on vase posts; cornices of lavender fans (joint), lattice on tongue brackets (eave) and stars (tower) | done: 84 parts, print files (26 h 6 m, 595 g; 3 plates with one filament change) |
| 27 | The Camellia | Queen Anne after the user's photo, 200 x 132 mm (Rev B): pink banded lap under key-cut shingles, a round tower under a black bell roof, a pavilion with a steep gable and a canted bay, keyhole bargeboards, a barley-twist porch, a basket-weave forecourt with two street lamps; cornices of raspberry swags (joint), ovals on ring brackets (eave), flutes (tower) and studs (bay) | done: 80 parts, print files (25 h 53 m, 588 g; 3 plates with one filament change) |
| 28 | The Wisteria | Storey-and-a-half cottage, 200 x 104 mm (Rev B): lavender wide-and-narrow lap, a steep side-gabled roof with a front wing and two hipped dormers, crescent gable ornaments, a porch curving round the corner on octagonal posts with wisteria clusters; an eave cornice of plum quatrefoils on comma brackets | done: 47 parts, print files (17 h 33 m, 418 g; 2 plates with one filament change) |
| 29 | The Hawthorn | Eastlake house with a square tower, 190 x 136 mm (Rev B): oxblood cove-and-bead siding, a star gable, a tower rising a storey over the eave to a pyramid with a pineapple finial, a porch on tapered posts; cornices of a mustard zigzag (joint), sunflowers on ladder brackets (eave) and chevrons (tower) | done: 58 parts, print files (19 h 20 m, 503 g; 3 plates with one filament change) |
| 30 | The Magnolia | Twin-gabled house with an entry loggia, 208 x 128 mm (Rev B): English cross bond brick below and step-cut shingles above, two front gables with arcade ornaments, a loggia sunk into the ground storey behind three segmental arches; cornices of ivory little arches (joint) and chocolate lozenges on stepped brackets (eave) | done: 48 parts, print files (20 h 27 m, 448 g; 3 plates with one filament change) |
| 31 | The Whitmore | Georgian Colonial (photo 4): red brick, a centre pavilion under a pediment with an oculus, a Palladian window with a balcony over a columned entry portico, copper-roofed bay windows either side, a slate hip roof with three dormers, a modillion cornice, tall end chimneys | approved; print files and build guide done |
| 32 | The Pennock | Pennsylvania fieldstone Colonial (photo 2), 196 x 144 mm: roughly coursed fieldstone with drafted quoins on a ledgestone foundation, flat-bottomed rubble arches over every window, nine-over-six sash under drip caps below and six-over-six in eared frames above, oxblood two-panel shutters on strap hinges; a pent roof of riven shakes across the front and pent eaves across both gables; cornices of compass stars, wolf's teeth and a torus (joint), gadroons, dentils and a deep cove (eave), whirling rosettes (the ell); a strap-hinged double door under a pedimented hood on scrolled consoles, a stone stoop with a settle either side; a riven-shake side-gabled roof with two arched tin-roofed dormers, fieldstone end stacks under stone hoods, a J P 1768 datestone in the west gable, and a one-storey kitchen ell behind | approved; print files and build guide done |
| 33 | The Oakhurst | Southern Colonial (photo 3), 232 x 104 mm: buttermilk brick in American bond with Flemish header courses on a raised red-brick basement with arched vents; a giant portico of four fluted Greek Doric columns on a planked floor up broad steps, an architrave of two fasciae, a pediment with a fanned lunette, a coffered haint-blue ceiling; a Greek Revival entrance (paired panelled leaves, sidelights and transom leaded in lozenges) and a French door onto a balcony railed in wrought-iron scrolls; six-over-nine windows under pedimented lintels below, six-over-six under tabled lintels above, plantation shutters; cornices of pineapples (joint), magnolia blossoms (eave and portico) and lotus and bud (the wing); a keyed-slate hip roof, segmental-pediment dormers on the ends, acroterion-capped stacks, a louvered cupola under a ribbed copper dome; an east wing with a roof terrace behind a sawn balustrade | approved; print files and build guide done |
| 34 | The Van Tassel | Dutch Colonial, 190 x 96 mm and a 24 mm porch: a storey and a half of red Jersey sandstone (coursed ashlar, each block's face tooled in furrows) on field boulders under a sandstone sill; a gambrel roof of chisel-cut shakes banded with swallowtails, its front slope sweeping out in a Dutch kick over a porch the width of the house on six round posts; double-coursed white shingles in the gambrel ends with quarter-round lights either side of the flue; a Dutch door with bull's-eye lights and ogee 'bell' head boards over the windows, Delft-blue board-and-batten shutters cut with crescent moons; a Delft-tile frieze at the eave; a long shed dormer behind; stacks of sandstone below and brick above | approved; print files and build guide done |
| 35 | The Hathaway | New England saltbox, 168 x 132 mm: two storeys in front and one behind under a long catslide roof; Spanish-brown graduated clapboard (narrow courses at each storey's foot, widening upward, a bead on every butt) on split granite still showing its drill holes; nine-over-nine windows under drip boards below and tight under the eave above; a six-panel door between fluted pilasters under a broken swan-neck pediment with an urn finial; cornices of chain links (the joint, running on round the lean-to's eave) and trees of life (the front eave); a massive centre chimney with corner piers and four pots; shakes banded bevel and square | approved; print files and build guide done |
| 36 | The Chatham | Cape Cod, 194 x 84 mm with its wing: a storey and a half under a steep side-gabled roof; weathered silver shingles (every fifth course diamond-pointed) on a tabby foundation studded with shell; a cross-and-bible door under a five-light transom between lozenge-sunk pilasters and a dentilled cap, a millstone for its step; six-over-six windows under little shed hoods on knee brackets, navy board shutters cut with pine trees; an eave frieze of fouled anchors over a rope course; three shingle-cheeked dormers with drops; a centre chimney with a soldier band and three flues; a lower east wing with a frieze of sailor's knots | approved; print files and build guide done |
| 37 | The Winthrop | Garrison Colonial, 172 x 93 mm: an oxblood brick lower storey in rat-trap bond on galleted stone, an oyster clapboard upper storey (scarfed board ends) jettied 5 mm out over the front on six turned acorn drops; segmental-arched windows below, key-capped windows above, small lights in the gables; a Tudor-arched door of studded chevron boards between fluted pilasters, carved spandrels and label stops under a crowned head; a joint frieze of linenfold panels over a cable course, an eave frieze of acorns over dentils; two exterior end chimneys of English-bond brick stepping in on two shoulders, each with a sunk panel of lozenges | approved; print files and build guide done |
| 38 | The Westbrook | Colonial front, Victorian flair (photo 1): white clapboard and black shutters, a curved two-storey porch on round columns with a balustraded balcony on top, arched-window dormers on a slate hip roof, a side wing | approved; print files and build guide done |
| 39 | The Ellsworth | Colonial front, Victorian flair, 216 x 139 mm with its porch: a symmetrical five-bay Colonial Revival front under a hip roof of ogee-pointed slates; Delft-blue double-course lap below, pale-blue wave-coursed shingles above, on cobblestones laid in rows; a hexagonal corner tower rising a stage over the eave to a verdigris copper ogee roof (flat-seam courses, rolled hips) and a flame finial, two faces of windows a storey and blind roundel panels on its top stage; a porch across the front, round the tower and down the east side on panelled pedestals with short Tuscan columns, bottle balusters, an ochre festoon frieze with tassels, a fascia of guttae, a louvred skirt and a segmental pediment with a cartouche over the steps; ochre friezes of lyres (joint), torches and bowknots over ogee consoles (eave) and waterleaf (tower); divided-sash windows under a cushion frieze below, six-over-one windows under a carved festoon above; a leaded doorway (oval light, lozenge sidelights, an elliptical fanlight of rays) between fluted Ionic pilasters under a keyed archivolt; two broken-pediment dormers with turned urns; a herringbone-panelled chimney with crock pots | approved; print files and build guide done |
| 40 | The Fairhaven | Colonial front, Victorian flair, 204 x 120 mm: a symmetrical two-storey front under a side-gabled roof of pinked slates; celadon channel rustic siding below, moss lap of two exposures in turn above, on snecked stone; two canted bays rising the full two storeys either side of the entrance under low hips; a front cross-gable with a Palladian window (fluted mullions, running entablature, keyed archivolt); a veranda between the bays on turned candlestick posts with cup-and-ring balusters, a terracotta frieze of interlocking rings, a Vitruvian-scroll fascia and a cloverleaf-pierced skirt; terracotta friezes of wheat sheaves (joint) and trailing ivy over palmette consoles (eave); two-over-two windows under ogee hoods with finials below, consoled caps over panelled aprons above, lunettes in the end gables; glazed double doors under a leaded fan-and-drape transom and a hood on tall consoles; two quoined Flemish-bond chimneys | approved; print files and build guide done |
