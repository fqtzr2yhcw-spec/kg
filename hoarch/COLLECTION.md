...
started (11 to 14); the lineup render is `out/lineup/cycles/lineup.png`
(built by merging each building's render data); the four shops stand side by side in
`out/mainstreet/cycles/street.png`. Every building has 0 interfering part pairs.
