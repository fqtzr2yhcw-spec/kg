...
| 9 | The Hollis | Folk Victorian farmhouse, an L 176 x 136 mm (Rev B): Dutch lap siding with chevron boarding in the gables, gingerbread gables, pedimented window crowns, board shutters, a spindle porch in the corner of the L and a back porch along the wing (Rev C); cornices of a green chain of diamonds (joint) and sawn teeth on knee brackets (eave) | done: 96 parts, print files (16 h 28 m, 448 g; 3 plates with one filament change) |
